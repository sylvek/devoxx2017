module Fastlane
  module Actions
    ...
    class SignApkAction < Action
      ...
      UI.error!("Couldn't find '*release-unsigned.apk' file at path 'app/build/outputs/apk/'") unless params[:apk_path]

      UI.error("Need keystore in order to sign apk") unless params[:keystore_path]
